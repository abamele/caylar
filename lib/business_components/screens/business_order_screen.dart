...
class BusinessOrderScreen extends StatefulWidget {
  late List dealerList;
  BusinessOrderScreen({Key? key, required this.dealerList}) : super(key: key);

  @override
  _BusinessOrderScreenState createState() => _BusinessOrderScreenState();
}

class _BusinessOrderScreenState extends State<BusinessOrderScreen> {
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          heroTag:
                                                                              "minus$index",
                                                                          backgroundColor:
                                                                              const Color(0xFF8C6F4B),
                                                                          onPressed:
                                                                              () {
                                                                            double
                                                                                price =
                                                                                double.parse("${productList[index]['price']}");
                                                                            if (counter.orderCounter[index] >
                                                                                0) {
                                                                              totalPrice.value = totalPrice.value - price;
                                                                            }
                                                                            orderCounterNotify.discrementCounter(index);
                                                                            var pureTotalPrice =
                                                                                productList[index]["price"] * counter.orderCounter[index];
                                                                            pureTotalPrice = pureTotalPrice.runtimeType == int
                                                                                ? pureTotalPrice.toDouble()
                                                                                : pureTotalPrice;
                                                                            orderList[index] =
                                                                                {
                          ...
                          onPressed: () {
                            ...
                            if (orderList != null) {
                              for (var i = 0; i < orderList.length; i++) {
                                if (orderList[i]["productQuantity"] != null) {
                                  makeOrderList.add({
